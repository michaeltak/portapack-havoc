/***********************************************************************
 * $Id:: mw_usbd_mscuser.h 2219 2015-12-08 22:18:38Z usb00423                  $
 *
...
typedef struct USBD_MSC_INIT_PARAM {
	 ...
	 *
	 *  \param[in] Lower 32 bit offset of Destination start address.
	 ...
	 *	 \param[in] Higher 32 bit offset of start address.
	 *  \return Nothing.
	 *
	 */
	 ...
	 *
	 *  \param[in] Lower 32 bit offset of Source start address.
